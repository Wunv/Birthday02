$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
			...
			$('.begin').html('<a href="Memories.html" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;">开启魔法</a>');
			$('.begin').fadeIn();
            return;
        }
    };
    function animateFct(i) {
        ...
        li.eq(i).find('img').css({width:'350px',height:'auto'})
        li.eq(i).show();
